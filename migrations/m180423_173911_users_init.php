...
/**
 * Class m180423_173911_users_init
 */
class m180423_173911_users_init extends Migration
{
    public function up()
    {
        ...
        $this->addForeignKey('fk-order_list-created_by','{{%order_list}}','created_by','{{%user}}','id');
    }

    public function down()
    {
        $this->dropForeignKey('fk-order_list-created_by','{{%order_list}}');
