            ...
            <div class="row">
                <div class="col-lg-3">
                    <h2 align="center">Рабочее меню</h2>
                        ...
                        <p><?=Html::a('Создать заявку на раскрой',['/admin/order-item/index'],['class'=>'btn btn-success btn-sm btn-block', 'style'=>'padding-top: 16px; padding-bottom: 16px; font-size: 17px; margin-top: 30px; margin-bottom: 30px;']);?></p>             
                </div>
                <div class="col-lg-9">
