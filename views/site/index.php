            ...
            <div class="row">
                <div class="col-lg-3">
                    <h2 align="center">Рабочее меню</h2>
                        <p><?=Html::a('Перейти в редактор формата',['/admin/format-list/index'],['class'=>'btn btn-success btn-sm btn-block', 'style'=>'padding-top: 16px; padding-bottom: 16px; font-size: 17px; margin-top: 7px; margin-bottom: 30px']);?></p>
                ...
                <div class="col-lg-9">
                    <h2 align="center">Краткая иснструкция</h2>
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">Если расчет раскроя оказался подходящим, то карту раскроя с параметрами расчета можно распчатать.</li>
